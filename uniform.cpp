...
uniform::uniform(utype t, const ustring &vs, void *trk):
...
{
    val = v;
    valstr = ustring::compose("(%1, %2)", v.x, v.y);
...
{
    val = v;
    valstr = ustring::compose("(%1, %2, %3)", v.x, v.y, v.z);
...
{
    val = v;
    valstr = ustring::compose("(%1, %2, %3, %4)", v.x, v.y, v.z, v.w);
...
{
    val = v;
    valstr = ustring::compose("((%1, %2), (%3, %4))",
            v[0][0], v[1][0],
            v[0][1], v[1][1]);
...
{
    val = v;
    valstr = ustring::compose("((%1, %2, %3), (%4, %5, %6), (%7, %8, %9))",
            v[0][0], v[1][0], v[2][0],
            v[0][1], v[1][1], v[2][1],
            v[0][2], v[1][2], v[2][2]);
...
{
    val = v;
    valstr = ustring::compose("((%1, %2, %3, %4), (%5, %6, %7, %8),",
            v[0][0], v[1][0], v[2][0], v[3][0],
            v[0][1], v[1][1], v[2][1], v[3][1])
           + ustring::compose(" (%1, %2, %3, %4), (%5, %6, %7, %8))",
